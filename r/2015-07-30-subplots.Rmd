...
Although subplot() accepts an arbitrary number of plot objects, passing a list of plots can save typing and redundant code when dealing with a large number of plots. For example, you can share the x-axis by utilising shareX, set axis ID, and specify the number of rows with nrows.

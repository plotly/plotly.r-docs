...
fig <-  ggplot(economics, aes(x=date,y=unemploy)) +
...
fig <-  ggplot(european_leaders, aes(xmin=stint_start, xmax=stint_end, ymin=vert_min, ymax=vert_max, fill=left_right)) +
...
fig <-  ggplotly(p, tooltip = c("label", "text")) #how to select what shows on the tooltip
